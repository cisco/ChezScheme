...
(define-symbol-flags* ([libraries] [flags primitive proc])
  ...
  (procedure-known-single-valued? [sig [(procedure) -> (boolean)]] [flags mifoldable discard])
...
(define-symbol-flags* ([libraries] [flags system proc]) ; system procedures
  ($address-in-heap? [flags single-valued])
  ...
  ($bigpositive? [flags single-valued])
  ...
  ($bytevector-compress [flags single-valued])
  ($bytevector-ref-check? [flags single-valued])
  ($bytevector-set!-check? [flags single-valued])
  ($bytevector-set! [flags single-valued])
  ($bytevector-set-immutable! #;[sig [(bytevector) -> (ptr)]] [flags true])
  ($bytevector-uncompress [flags single-valued])
  ...
  ($code-single-valued? [flags single-valued])
  ($collect-rendezvous [flags])
  ($compile-backend [flags single-valued])
  ($compiled-file-header? [flags single-valued])
  ...
  ($compressed-warning [flags single-valued])
  ($compute-composition [flags single-valued])
  ($compute-size [flags single-valued])
  ($constituent? [flags single-valued])
  ($constituent-ports [flags])
  ($continuation? [flags single-valued])
  ...
  ($distinct-bound-ids? [flags single-valued])
  ...
  ($error-handling-mode? [flags single-valued])
  ($event [flags single-valued])
  ($exactnum? [flags single-valued])
  ($exactnum-imag-part [flags single-valued])
  ($exactnum-real-part [flags single-valued])
  ($expand/cte/optimize #;[sig [(ptr) (ptr environment) -> (ptr)]] [flags single-valued])
  ($expand/cte #;[sig [(ptr) (ptr environment) -> (ptr)]] [flags single-valued])
  ...
  ($fasl-file-equal? #;[sig [(pathname pathname) (pathname pathname ptr) -> (boolean)]] [flags single-valued])
  ...
  ($fixed-path? [flags single-valued])
  ($<= [flags single-valued])
  ($< [flags single-valued])
  ($= [flags single-valued])
  ($- [flags single-valued])
  ...
  ($foreign-char? [flags single-valued pure unrestricted mifoldable discard])
  ($foreign-entries [flags single-valued])
  ($foreign-entry [flags single-valued discard])
  ($foreign-wchar? [flags single-valued pure unrestricted cp02])
  ...
  ($fxvector-ref-check? [flags single-valued])
  ($fxvector-set!-check? [flags single-valued])
  ...
  ($integer-16? [flags single-valued pure unrestricted mifoldable discard])
  ($integer-24? [flags single-valued pure unrestricted mifoldable discard])
  ($integer-32? [flags single-valued pure unrestricted mifoldable discard])
  ($integer-40? [flags single-valued pure unrestricted mifoldable discard])
  ($integer-48? [flags single-valued pure unrestricted mifoldable discard])
  ($integer-56? [flags single-valued pure unrestricted mifoldable discard])
  ($integer-64? [flags single-valued pure unrestricted mifoldable discard])
  ($integer-8? [flags single-valued pure unrestricted mifoldable discard])
  ...
  ($make-binary-input/output-port #;[sig [(string port-handler bytevector bytevector) (string port-handler bytevector bytevector ptr) -> (binary-input/output-port)]] [flags single-valued alloc])
  ($make-binary-input-port #;[sig [(string port-handler bytevector) (string port-handler bytevector ptr) -> (binary-input-port)]] [flags single-valued alloc])
  ($make-binary-output-port #;[sig [(string port-handler bytevector) (string port-handler bytevector ptr) -> (binary-output-port)]] [flags single-valued alloc])
  ...
  ($make-record-type #;[sig [(rtd maybe-rtd sub-ptr sub-list ptr ptr ptr ...) -> (rtd)]] [flags single-valued pure alloc cp02])
  ...
  ($make-textual-input/output-port #;[sig [(string port-handler string string) (string port-handler string string ptr) -> (textual-input/output-port)]] [flags single-valued alloc])
  ($make-textual-input-port #;[sig [(string port-handler string) (string port-handler string ptr) -> (textual-input-port)]] [flags single-valued alloc])
  ($make-textual-output-port #;[sig [(string port-handler string) (string port-handler string ptr) -> (textual-output-port)]] [flags single-valued alloc])
  ($make-tlc [flags single-valued alloc])
  ($make-vtable [flags single-valued])
  ($map [flags single-valued])
  ($mark-invoked! [flags single-valued])
  ($mark-pending! [flags single-valued])
  ($maybe-compile-file [flags single-valued])
  ($noexpand? [flags single-valued])
  ...
  ($object-in-heap? [flags single-valued])
  ...
  ($port-flags-set? [flags single-valued])
  ($port-handler [flags single-valued])
  ($port-info #;[sig [(port) -> (ptr)]] [flags single-valued discard])
  ($print-pass-stats [flags single-valued])
  ($procedure-name [flags single-valued])
  ($profile-block-data? [flags single-valued])
  ($profile-show-database [flags single-valued])
  ($profile-source-data? [flags single-valued])
  ...
  ($recompile-condition? [flags single-valued])
  ...
  ($record? [flags single-valued pure mifoldable discard])
  ...
  ($rtd-counts? [flags single-valued])
  ...
  ($sealed-record? [flags single-valued pure mifoldable discard])
  ...
  ($src-condition? [flags single-valued])
  ...
  ($string-ref-check? [flags single-valued])
  ($string-set!-check? [flags single-valued])
  ($string-set-immutable! #;[sig [(string) -> (ptr)]] [flags true])
  ($str->num [flags single-valued])
  ($subsequent? [flags single-valued])
  ...
  ($syntax-match? [flags single-valued])
  ($syntax->src [flags])
  ($syntax-top-level? [flags single-valued])
  ($system-code? [flags single-valued])
  ($system-environment [flags single-valued])
  ($system-library? [flags single-valued])
  ($system-procedure? [flags single-valued])
  ...
  ($tlc? [flags single-valued pure unrestricted mifoldable discard])
  ...
  ($top-level-bound? [flags single-valued discard single-valued])
  ...
  ($trans-ftype-pointer? [flags single-valued])
  ...
  ($unbound-object? [flags single-valued pure unrestricted mifoldable discard])
  ($unbound-object [flags single-valued pure unrestricted mifoldable discard true])
  ...
  ($value [flags pure unrestricted discard cp02])
  ($vector-ref-check? [flags single-valued])
  ($vector-set!-check? [flags single-valued])
  ...
  ($xscript-port? [flags single-valued])
)
...
(define-symbol-flags* ([libraries] [flags system proc]) ; system parameters
  ...
  ($cp0-inner-unroll-limit #;[sig [() -> (ufixnum)] [(ufixnum) -> (void)]] [flags single-valued])
  ($cp0-polyvariant #;[sig [() -> (boolean)] [(ptr) -> (void)]] [flags single-valued unrestricted])
  ...
  ($optimize-closures #;[sig [() -> (boolean)] [(ptr) -> (void)]] [flags single-valued unrestricted])
  ($suppress-primitive-inlining #;[sig [() -> (boolean)] [(ptr) -> (void)]] [flags single-valued unrestricted])
