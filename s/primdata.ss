...
(define-symbol-flags* ([libraries (rnrs) (rnrs arithmetic flonums)] [flags primitive proc])
  ...
  (flmax [sig [(flonum ...) -> (flonum)]] [flags arith-op mifoldable discard])
  (flmin [sig [(flonum ...) -> (flonum)]] [flags arith-op mifoldable discard])
...
(define-symbol-flags* ([libraries (rnrs) (rnrs base)] [flags primitive proc])
  ...
  (max [sig [(real ...) -> (real)]] [flags arith-op mifoldable discard ieee r5rs])
  (min [sig [(real ...) -> (real)]] [flags arith-op mifoldable discard ieee r5rs])
