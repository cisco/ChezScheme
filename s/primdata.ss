...
(define-symbol-flags* ([libraries] [flags primitive proc])
  ...
  (call-in-continuation [sig [(ptr procedure) -> (ptr ...)] [(ptr continuation-mark-set procedure) -> (ptr ...)]] [flags])
  ...
  (continuation-mark-set? [sig [(ptr) -> (boolean)]] [flags pure unrestricted mifoldable discard])
  (continuation-mark-set->iterator [sig [(continuation-mark-set vector) -> (ptr prcedure)] [(continuation-mark-set vector ptr) -> (ptr prcedure)]] [flags])
  (continuation-mark-set-first [sig [(continuation-mark-set ptr) -> (ptr)] [(continuation-mark-set ptr ptr) -> (ptr)]] [flags cp02])
  (continuation-mark-set->list [sig [(continuation-mark-set ptr) -> (list)]] [flags])
  (continuation-next-marks [sig [(sub-ptr) -> (continuation-mark-set)]] [flags])
  ...
  (current-continuation-marks [sig [() -> (continuation-mark-set)]] [flags alloc])
...
(define-symbol-flags* ([libraries] [flags system proc]) ; system procedures
  ...
  ($continuation-mark-set-first [flags single-valued])
