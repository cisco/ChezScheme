...
(define-symbol-flags* ([libraries] [flags system proc]) ; system procedures
  ...
  ($byte-copy! [flags])
  ($bytevector-ref-check? [sig [(sub-uint bytevector sub-index) -> (boolean)]] [flags pure])
  ($bytevector-set!-check? [sig [(sub-uint bytevector sub-index) -> (boolean)]] [flags discard])
  ...
  ($compound-condition? [sig [(char) -> (boolean)]] [flags pure unrestricted mifoldable])
  ...
  ($foreign-char? [sig [(ptr) -> (boolean)]] [flags pure unrestricted mifoldable])
  ...
  ($fx-? [sig [(maybe-fixnum maybe-fixnum) -> (maybe-fixnum)]] [flags pure])
  ($fx/ [flags])
  ($fx* [flags])
  ($fx+? [sig [(maybe-fixnum maybe-fixnum) -> (maybe-fixnum)]] [flags pure])
  ($fxu< [flags pure cp02])
  ($fxvector-ref-check? [sig [(fxvector sub-index) -> (boolean)]] [flags pure])
  ($fxvector-set!-check? [sig [(fxvector sub-index) -> (boolean)]] [flags discard])
  ...
  ($integer-16? [sig [(ptr) -> (boolean)]] [flags pure unrestricted mifoldable])
  ($integer-24? [sig [(ptr) -> (boolean)]] [flags pure unrestricted mifoldable])
  ($integer-32? [sig [(ptr) -> (boolean)]] [flags pure unrestricted mifoldable])
  ($integer-40? [sig [(ptr) -> (boolean)]] [flags pure unrestricted mifoldable])
  ($integer-48? [sig [(ptr) -> (boolean)]] [flags pure unrestricted mifoldable])
  ($integer-56? [sig [(ptr) -> (boolean)]] [flags pure unrestricted mifoldable])
  ($integer-64? [sig [(ptr) -> (boolean)]] [flags pure unrestricted mifoldable])
  ($integer-8? [sig [(ptr) -> (boolean)]] [flags pure unrestricted mifoldable])
  ($intern2 [flags])
  ($intern3 [flags])
  ($intern-gensym [flags])
  ...
  ($record [sig [(rtd ptr ...) -> (record)]] [flags cp02 unrestricted alloc]) ; first arg should be an rtd, but we don't check
  ...
  ($script [flags])
  ($sealed-record? [sig [(record rtd) -> (boolean)]] [flags pure mifoldable])
  ($set-code-byte! [flags])
  ($set-code-long! [flags])
  ($set-code-quad! [flags])
  ($set-code-word! [flags])
  ...
  ($string-ref-check? [sig [(string sub-index) -> (boolean)]] [flags pure])
  ($string-set!-check? [sig [(string sub-index) -> (boolean)]] [flags discard])
  ...
  ($syntax->src [flags])
  ($syntax-top-level? [sig [() -> (boolean)]] [flags discard])
  ...
  ($trans-ftype-pointer? [sig [(ptr) -> (procedure)]] [flags alloc])
  ...
  ($vector-ref-check? [sig [(vector sub-index) -> (boolean)]] [flags pure])
  ($vector-set!-check? [sig [(vector sub-index) -> (boolean)]] [flags discard])
