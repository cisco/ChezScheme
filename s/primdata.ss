...
(define-symbol-flags* ([libraries] [flags primitive proc])
  ...
  (box-immutable? [sig [(box) -> (boolean?)]] [flags discard])
  ...
  (bytevector-immutable? [sig [(bytevector) -> (boolean)]] [flags discard])
  ...
  (fxvector-immutable? [sig [(fxvector) -> (boolean)]] [flags discard])
  ...
  (string-immutable? [sig [(string) -> (boolean)]] [flags discard])
  ...
  (vector-immutable? [sig [(vector) -> (boolean)]] [flags discard])
...
(define-symbol-flags* ([libraries] [flags system proc]) ; system procedures
  ...
  ($null-immutable-bytevector [flags])
  ($null-immutable-fxvector [flags])
  ($null-immutable-string [flags])
  ($null-immutable-vector [flags])
