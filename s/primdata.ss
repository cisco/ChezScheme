...
(define-symbol-flags* ([libraries (rnrs) (rnrs base)] [flags primitive proc])
 ...
 ; c..r non-alphabetic so marks come before references
  ...
  (string-for-each [sig [(procedure string string ...) -> (void)]] [flags true cp03])
  ...
  (vector-for-each [sig [(procedure vector vector ...) -> (void)]] [flags true cp03])
...
(define-symbol-flags* ([libraries] [flags primitive proc])
  ...
  (compile-to-file [sig [(list pathname) (list pathname maybe-sfd) -> (void)]] [flags true])
  (compile-to-port [sig [(list binary-output-port) (list binary-output-port maybe-sfd) (list binary-output-port maybe-sfd maybe-binary-output-port) (list binary-output-port maybe-sfd maybe-binary-output-port sub-symbol)  (list binary-output-port maybe-sfd maybe-binary-output-port sub-symbol maybe-binary-output-port) (list binary-output-port maybe-sfd maybe-binary-output-port sub-symbol maybe-binary-output-port maybe-pathname) -> (void)]] [flags true])
  ...
  (ftype-pointer-ftype [sig [(ftype-pointer) -> (list)]] [flags mifoldable discard true])
  (ftype-pointer-null? [sig [(ftype-pointer) -> (boolean)]] [flags pure mifoldable discard])
  (ftype-pointer->sexpr [sig [(ftype-pointer) -> (list)]] [flags true])
  ...
  (make-compile-time-value [sig [(ptr) (ptr ptr) -> (compile-time-value)]] [flags pure unrestricted alloc])
  ...
  (remprop [sig [(symbol ptr) -> (void)]] [flags true])
