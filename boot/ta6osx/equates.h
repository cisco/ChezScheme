...
#define library_entry_vector_size 0x216
...
#define tc_U_disp 0x170
#define tc_V_disp 0x178
#define tc_W_disp 0x180
#define tc_X_disp 0x188
#define tc_Y_disp 0x190
...
#define tc_attachments_disp 0x160
#define tc_block_counter_disp 0x1E8
#define tc_cached_frame_disp 0x168
...
#define tc_current_error_disp 0x1E0
#define tc_current_input_disp 0x1D0
#define tc_current_mso_disp 0x1F8
#define tc_current_output_disp 0x1D8
#define tc_default_record_equal_procedure_disp 0x278
#define tc_default_record_hash_procedure_disp 0x280
#define tc_disable_count_disp 0x1A8
#define tc_eap_disp 0x58
#define tc_esp_disp 0x48
#define tc_fxfirst_bit_set_bv_disp 0x210
#define tc_fxlength_bv_disp 0x208
...
#define tc_keyboard_interrupt_pending_disp 0x1C0
#define tc_lz4_out_buffer_disp 0x298
#define tc_meta_level_disp 0x238
#define tc_null_immutable_bytevector_disp 0x228
#define tc_null_immutable_fxvector_disp 0x220
#define tc_null_immutable_string_disp 0x230
#define tc_null_immutable_vector_disp 0x218
...
#define tc_sfd_disp 0x1F0
#define tc_sfp_disp 0x38
#define tc_signal_interrupt_pending_disp 0x1B0
#define tc_signal_interrupt_queue_disp 0x1B8
#define tc_something_pending_disp 0x198
...
#define tc_target_machine_disp 0x200
#define tc_td_disp 0x88
#define tc_threadno_disp 0x1C8
#define tc_timer_ticks_disp 0x1A0
...
#define CONTATTACHMENTS(x) (*((ptr *)((uptr)(x)+59)))
...
/* thread-context data */
#define DSTBV(x) (*((ptr *)((uptr)(x)+696)))
#define SRCBV(x) (*((ptr *)((uptr)(x)+704)))
#define U(x) (*((ptr *)((uptr)(x)+368)))
#define V(x) (*((ptr *)((uptr)(x)+376)))
#define W(x) (*((ptr *)((uptr)(x)+384)))
#define X(x) (*((ptr *)((uptr)(x)+392)))
#define Y(x) (*((ptr *)((uptr)(x)+400)))
#define AC0(x) (*((void* *)((uptr)(x)+40)))
#define AC1(x) (*((void* *)((uptr)(x)+48)))
#define ACTIVE(x) (*((I32 *)((uptr)(x)+308)))
#define ALLOCCOUNTER(x) (*((U64 *)((uptr)(x)+680)))
#define AP(x) (*((void* *)((uptr)(x)+80)))
#define ARGREGS(x,i) (((void* *)((uptr)(x)+0))[i])
#define ATTACHMENTS(x) (*((ptr *)((uptr)(x)+352)))
#define BLOCKCOUNTER(x) (*((ptr *)((uptr)(x)+488)))
#define CACHEDFRAME(x) (*((ptr *)((uptr)(x)+360)))
#define CCHAIN(x) (*((ptr *)((uptr)(x)+288)))
#define CODERANGESTOFLUSH(x) (*((ptr *)((uptr)(x)+296)))
#define COMPILEPROFILE(x) (*((ptr *)((uptr)(x)+576)))
#define COMPRESSFORMAT(x) (*((ptr *)((uptr)(x)+648)))
#define COMPRESSLEVEL(x) (*((ptr *)((uptr)(x)+656)))
#define CP(x) (*((void* *)((uptr)(x)+64)))
#define CURRENTERROR(x) (*((ptr *)((uptr)(x)+480)))
#define CURRENTINPUT(x) (*((ptr *)((uptr)(x)+464)))
#define CURRENTMSO(x) (*((ptr *)((uptr)(x)+504)))
#define CURRENTOUTPUT(x) (*((ptr *)((uptr)(x)+472)))
#define DEFAULTRECORDEQUALPROCEDURE(x) (*((ptr *)((uptr)(x)+632)))
#define DEFAULTRECORDHASHPROCEDURE(x) (*((ptr *)((uptr)(x)+640)))
#define DISABLECOUNT(x) (*((ptr *)((uptr)(x)+424)))
#define EAP(x) (*((void* *)((uptr)(x)+88)))
#define ESP(x) (*((void* *)((uptr)(x)+72)))
#define FXFIRSTBITSETBV(x) (*((ptr *)((uptr)(x)+528)))
#define FXLENGTHBV(x) (*((ptr *)((uptr)(x)+520)))
#define GENERATEINSPECTORINFORMATION(x) (*((ptr *)((uptr)(x)+584)))
#define GENERATEPROCEDURESOURCEINFORMATION(x) (*((ptr *)((uptr)(x)+592)))
#define GENERATEPROFILEFORMS(x) (*((ptr *)((uptr)(x)+600)))
#define GUARDIANENTRIES(x) (*((ptr *)((uptr)(x)+280)))
#define INSTRCOUNTER(x) (*((U64 *)((uptr)(x)+672)))
#define KEYBOARDINTERRUPTPENDING(x) (*((ptr *)((uptr)(x)+448)))
#define LZ4OUTBUFFER(x) (*((void* *)((uptr)(x)+664)))
#define METALEVEL(x) (*((ptr *)((uptr)(x)+568)))
#define NULLIMMUTABLEBYTEVECTOR(x) (*((ptr *)((uptr)(x)+552)))
#define NULLIMMUTABLEFXVECTOR(x) (*((ptr *)((uptr)(x)+544)))
#define NULLIMMUTABLESTRING(x) (*((ptr *)((uptr)(x)+560)))
#define NULLIMMUTABLEVECTOR(x) (*((ptr *)((uptr)(x)+536)))
#define OPTIMIZELEVEL(x) (*((ptr *)((uptr)(x)+608)))
#define PARAMETERS(x) (*((ptr *)((uptr)(x)+688)))
...
#define SFD(x) (*((ptr *)((uptr)(x)+496)))
#define SFP(x) (*((void* *)((uptr)(x)+56)))
#define SIGNALINTERRUPTPENDING(x) (*((ptr *)((uptr)(x)+432)))
#define SIGNALINTERRUPTQUEUE(x) (*((ptr *)((uptr)(x)+440)))
#define SOMETHINGPENDING(x) (*((ptr *)((uptr)(x)+408)))
#define STACKCACHE(x) (*((ptr *)((uptr)(x)+320)))
#define STACKLINK(x) (*((ptr *)((uptr)(x)+328)))
#define SUBSETMODE(x) (*((ptr *)((uptr)(x)+616)))
#define SUPPRESSPRIMITIVEINLINING(x) (*((ptr *)((uptr)(x)+624)))
#define TARGETMACHINE(x) (*((ptr *)((uptr)(x)+512)))
#define TD(x) (*((void* *)((uptr)(x)+136)))
#define THREADNO(x) (*((ptr *)((uptr)(x)+456)))
#define TIMERTICKS(x) (*((ptr *)((uptr)(x)+416)))
