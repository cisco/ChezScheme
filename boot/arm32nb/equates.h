/* equates.h for Chez Scheme Version 9.4 */
...
#define machine_type_name arm32nb
#define machine_type_ppc32le 0x23
...
#define machine_type_tarm32nb 0x22
...
#define machine_type_tppc32le 0x24
...
#define tc_alloc_counter_disp 0x128
...
#define tc_compile_profile_disp 0x104
...
#define tc_fxfirst_bit_set_bv_disp 0xFC
#define tc_fxlength_bv_disp 0xF8
#define tc_generate_inspector_information_disp 0x108
#define tc_generate_profile_forms_disp 0x10C
#define tc_guardian_entries_disp 0x8C
#define tc_instr_counter_disp 0x120
#define tc_keyboard_interrupt_pending_disp 0xD8
#define tc_meta_level_disp 0x100
#define tc_optimize_level_disp 0x110
#define tc_parameters_disp 0x130
...
#define tc_subset_mode_disp 0x114
#define tc_suppress_primitive_inlining_disp 0x118
#define tc_target_machine_disp 0xF4
...
/* machine types */
#define machine_type_names {"any", "i3le", "ti3le", "i3nt", "ti3nt", "i3fb", "ti3fb", "i3ob", "ti3ob", "i3osx", "ti3osx", "a6le", "ta6le", "a6osx", "ta6osx", "a6ob", "ta6ob", "a6s2", "ta6s2", "i3s2", "ti3s2", "a6fb", "ta6fb", "i3nb", "ti3nb", "a6nb", "ta6nb", "a6nt", "ta6nt", "i3qnx", "ti3qnx", "arm32le", "tarm32le", "arm32nb", "tarm32nb", "ppc32le", "tppc32le"}
...
#define ALLOCCOUNTER(x) (*((U64 *)((uptr)(x)+296)))
...
#define COMPILEPROFILE(x) (*((ptr *)((uptr)(x)+260)))
...
#define FXFIRSTBITSETBV(x) (*((ptr *)((uptr)(x)+252)))
#define FXLENGTHBV(x) (*((ptr *)((uptr)(x)+248)))
#define GENERATEINSPECTORINFORMATION(x) (*((ptr *)((uptr)(x)+264)))
#define GENERATEPROFILEFORMS(x) (*((ptr *)((uptr)(x)+268)))
#define GUARDIANENTRIES(x) (*((ptr *)((uptr)(x)+140)))
#define INSTRCOUNTER(x) (*((U64 *)((uptr)(x)+288)))
#define KEYBOARDINTERRUPTPENDING(x) (*((ptr *)((uptr)(x)+216)))
#define METALEVEL(x) (*((ptr *)((uptr)(x)+256)))
#define OPTIMIZELEVEL(x) (*((ptr *)((uptr)(x)+272)))
#define PARAMETERS(x) (*((ptr *)((uptr)(x)+304)))
...
#define SUBSETMODE(x) (*((ptr *)((uptr)(x)+276)))
#define SUPPRESSPRIMITIVEINLINING(x) (*((ptr *)((uptr)(x)+280)))
#define TARGETMACHINE(x) (*((ptr *)((uptr)(x)+244)))
