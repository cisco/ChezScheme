...
#define machine_type_name ti3osx
...
#define tc_alloc_counter_disp 0x124
...
#define tc_instr_counter_disp 0x11C
...
#define tc_parameters_disp 0x12C
...
#define ALLOCCOUNTER(x) (*((U64 *)((uptr)(x)+292)))
...
#define INSTRCOUNTER(x) (*((U64 *)((uptr)(x)+284)))
...
#define PARAMETERS(x) (*((ptr *)((uptr)(x)+300)))
