...
#define architecture la64
#define asm_arg_reg_cnt 0x8
#define asm_arg_reg_max 0xF
...
#define machine_type_la64le 0x25
#define machine_type_limit 0x29
#define machine_type_name tla64le
#define machine_type_ppc32le 0x21
#define machine_type_rv64le 0x23
...
#define machine_type_taarch64le 0x28
...
#define machine_type_tla64le 0x26
#define machine_type_tppc32le 0x22
#define machine_type_trv64le 0x24
...
#define reloc_la64_abs 0x1
#define reloc_la64_call 0x2
#define reloc_la64_jump 0x3
...
#define tc_DSTBV_disp 0x2F8
#define tc_SRCBV_disp 0x300
#define tc_U_disp 0x1B0
#define tc_V_disp 0x1B8
#define tc_W_disp 0x1C0
#define tc_X_disp 0x1C8
#define tc_Y_disp 0x1D0
#define tc_ac0_disp 0x78
#define tc_ac1_disp 0x80
#define tc_active_disp 0x184
#define tc_alloc_counter_disp 0x2E8
#define tc_ap_disp 0xA0
#define tc_arg_regs_disp 0x0
#define tc_block_counter_disp 0x228
#define tc_cchain_disp 0x170
#define tc_code_ranges_to_flush_disp 0x178
#define tc_compile_profile_disp 0x280
#define tc_compress_format_disp 0x2C8
#define tc_compress_level_disp 0x2D0
#define tc_cp_disp 0x90
#define tc_current_error_disp 0x220
#define tc_current_input_disp 0x210
#define tc_current_mso_disp 0x238
#define tc_current_output_disp 0x218
#define tc_default_record_equal_procedure_disp 0x2B8
#define tc_default_record_hash_procedure_disp 0x2C0
#define tc_disable_count_disp 0x1E8
#define tc_eap_disp 0xA8
#define tc_esp_disp 0x98
#define tc_fxfirst_bit_set_bv_disp 0x250
#define tc_fxlength_bv_disp 0x248
#define tc_generate_inspector_information_disp 0x288
#define tc_generate_procedure_source_information_disp 0x290
#define tc_generate_profile_forms_disp 0x298
#define tc_guardian_entries_disp 0x168
#define tc_instr_counter_disp 0x2E0
#define tc_keyboard_interrupt_pending_disp 0x200
#define tc_lz4_out_buffer_disp 0x2D8
#define tc_meta_level_disp 0x278
#define tc_null_immutable_bytevector_disp 0x268
#define tc_null_immutable_fxvector_disp 0x260
#define tc_null_immutable_string_disp 0x270
#define tc_null_immutable_vector_disp 0x258
#define tc_optimize_level_disp 0x2A0
#define tc_parameters_disp 0x2F0
#define tc_random_seed_disp 0x180
#define tc_real_eap_disp 0xE0
#define tc_ret_disp 0xB0
#define tc_scheme_stack_disp 0x188
#define tc_scheme_stack_size_disp 0x1A0
#define tc_sfd_disp 0x230
#define tc_sfp_disp 0x88
#define tc_signal_interrupt_pending_disp 0x1F0
#define tc_signal_interrupt_queue_disp 0x1F8
#define tc_something_pending_disp 0x1D8
#define tc_stack_cache_disp 0x190
#define tc_stack_link_disp 0x198
#define tc_subset_mode_disp 0x2A8
#define tc_suppress_primitive_inlining_disp 0x2B0
#define tc_target_machine_disp 0x240
#define tc_td_disp 0xD8
#define tc_threadno_disp 0x208
#define tc_timer_ticks_disp 0x1E0
#define tc_trap_disp 0xB8
#define tc_ts_disp 0xD0
#define tc_virtual_registers_disp 0xE8
#define tc_winders_disp 0x1A8
#define tc_xp_disp 0xC0
#define tc_yp_disp 0xC8
...
/* machine types */
#define machine_type_names {"any", "i3le", "ti3le", "i3nt", "ti3nt", "i3fb", "ti3fb", "i3ob", "ti3ob", "i3osx", "ti3osx", "a6le", "ta6le", "a6osx", "ta6osx", "a6ob", "ta6ob", "a6s2", "ta6s2", "i3s2", "ti3s2", "a6fb", "ta6fb", "i3nb", "ti3nb", "a6nb", "ta6nb", "a6nt", "ta6nt", "i3qnx", "ti3qnx", "arm32le", "tarm32le", "ppc32le", "tppc32le", "rv64le", "trv64le", "la64le", "tla64le", "aarch64le", "taarch64le"}
...
/* thread-context data */
#define DSTBV(x) (*((ptr *)((uptr)(x)+760)))
#define SRCBV(x) (*((ptr *)((uptr)(x)+768)))
#define U(x) (*((ptr *)((uptr)(x)+432)))
#define V(x) (*((ptr *)((uptr)(x)+440)))
#define W(x) (*((ptr *)((uptr)(x)+448)))
#define X(x) (*((ptr *)((uptr)(x)+456)))
#define Y(x) (*((ptr *)((uptr)(x)+464)))
#define AC0(x) (*((void* *)((uptr)(x)+120)))
#define AC1(x) (*((void* *)((uptr)(x)+128)))
#define ACTIVE(x) (*((I32 *)((uptr)(x)+388)))
#define ALLOCCOUNTER(x) (*((U64 *)((uptr)(x)+744)))
#define AP(x) (*((void* *)((uptr)(x)+160)))
#define ARGREGS(x,i) (((void* *)((uptr)(x)+0))[i])
#define BLOCKCOUNTER(x) (*((ptr *)((uptr)(x)+552)))
#define CCHAIN(x) (*((ptr *)((uptr)(x)+368)))
#define CODERANGESTOFLUSH(x) (*((ptr *)((uptr)(x)+376)))
#define COMPILEPROFILE(x) (*((ptr *)((uptr)(x)+640)))
#define COMPRESSFORMAT(x) (*((ptr *)((uptr)(x)+712)))
#define COMPRESSLEVEL(x) (*((ptr *)((uptr)(x)+720)))
#define CP(x) (*((void* *)((uptr)(x)+144)))
#define CURRENTERROR(x) (*((ptr *)((uptr)(x)+544)))
#define CURRENTINPUT(x) (*((ptr *)((uptr)(x)+528)))
#define CURRENTMSO(x) (*((ptr *)((uptr)(x)+568)))
#define CURRENTOUTPUT(x) (*((ptr *)((uptr)(x)+536)))
#define DEFAULTRECORDEQUALPROCEDURE(x) (*((ptr *)((uptr)(x)+696)))
#define DEFAULTRECORDHASHPROCEDURE(x) (*((ptr *)((uptr)(x)+704)))
#define DISABLECOUNT(x) (*((ptr *)((uptr)(x)+488)))
#define EAP(x) (*((void* *)((uptr)(x)+168)))
#define ESP(x) (*((void* *)((uptr)(x)+152)))
#define FXFIRSTBITSETBV(x) (*((ptr *)((uptr)(x)+592)))
#define FXLENGTHBV(x) (*((ptr *)((uptr)(x)+584)))
#define GENERATEINSPECTORINFORMATION(x) (*((ptr *)((uptr)(x)+648)))
#define GENERATEPROCEDURESOURCEINFORMATION(x) (*((ptr *)((uptr)(x)+656)))
#define GENERATEPROFILEFORMS(x) (*((ptr *)((uptr)(x)+664)))
#define GUARDIANENTRIES(x) (*((ptr *)((uptr)(x)+360)))
#define INSTRCOUNTER(x) (*((U64 *)((uptr)(x)+736)))
#define KEYBOARDINTERRUPTPENDING(x) (*((ptr *)((uptr)(x)+512)))
#define LZ4OUTBUFFER(x) (*((void* *)((uptr)(x)+728)))
#define METALEVEL(x) (*((ptr *)((uptr)(x)+632)))
#define NULLIMMUTABLEBYTEVECTOR(x) (*((ptr *)((uptr)(x)+616)))
#define NULLIMMUTABLEFXVECTOR(x) (*((ptr *)((uptr)(x)+608)))
#define NULLIMMUTABLESTRING(x) (*((ptr *)((uptr)(x)+624)))
#define NULLIMMUTABLEVECTOR(x) (*((ptr *)((uptr)(x)+600)))
#define OPTIMIZELEVEL(x) (*((ptr *)((uptr)(x)+672)))
#define PARAMETERS(x) (*((ptr *)((uptr)(x)+752)))
#define RANDOMSEED(x) (*((U32 *)((uptr)(x)+384)))
#define REAL_EAP(x) (*((void* *)((uptr)(x)+224)))
#define RET(x) (*((void* *)((uptr)(x)+176)))
#define SCHEMESTACK(x) (*((void* *)((uptr)(x)+392)))
#define SCHEMESTACKSIZE(x) (*((iptr *)((uptr)(x)+416)))
#define SFD(x) (*((ptr *)((uptr)(x)+560)))
#define SFP(x) (*((void* *)((uptr)(x)+136)))
#define SIGNALINTERRUPTPENDING(x) (*((ptr *)((uptr)(x)+496)))
#define SIGNALINTERRUPTQUEUE(x) (*((ptr *)((uptr)(x)+504)))
#define SOMETHINGPENDING(x) (*((ptr *)((uptr)(x)+472)))
#define STACKCACHE(x) (*((ptr *)((uptr)(x)+400)))
#define STACKLINK(x) (*((ptr *)((uptr)(x)+408)))
#define SUBSETMODE(x) (*((ptr *)((uptr)(x)+680)))
#define SUPPRESSPRIMITIVEINLINING(x) (*((ptr *)((uptr)(x)+688)))
#define TARGETMACHINE(x) (*((ptr *)((uptr)(x)+576)))
#define TD(x) (*((void* *)((uptr)(x)+216)))
#define THREADNO(x) (*((ptr *)((uptr)(x)+520)))
#define TIMERTICKS(x) (*((ptr *)((uptr)(x)+480)))
#define TRAP(x) (*((void* *)((uptr)(x)+184)))
#define TS(x) (*((void* *)((uptr)(x)+208)))
#define VIRTUALREGISTERS(x,i) (((ptr *)((uptr)(x)+232))[i])
#define WINDERS(x) (*((ptr *)((uptr)(x)+424)))
#define XP(x) (*((void* *)((uptr)(x)+192)))
#define YP(x) (*((void* *)((uptr)(x)+200)))
#define ARGREG(x,i) (((void* *)((uptr)(x)+0))[i])
#define VIRTREG(x,i) (((ptr *)((uptr)(x)+232))[i])
