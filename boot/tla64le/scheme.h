/* scheme.h for Chez Scheme Version 9.5.9 (tla64le) */
...
#define INITLOCK(addr) \
  __asm__ __volatile__ ("st.d $r0, %0, 0   \n\t" \
                        : \
                        : "r" (addr) \
                        : "memory")
...
#define LOCKED_INCR(addr, ret)                                  \
  do {                                                         \
       long _ret_;                                             \
       long _temp_;                                            \
       __asm__ __volatile__ ("addi.d %[_ret_], $r0, 0   \n\t"  \
                             "1:\n\t"                          \
                             "ll.d   $r12, %[_addr_], 0       \n\t" \
                             "addi.d $r12, $r12, 1      \n\t" \
                             "add.d %[_temp_], $r0, $r12 \n\t" \
